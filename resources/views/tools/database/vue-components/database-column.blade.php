...
<tr class="newTableRow">
    ...
    <td>
        ...
        <small v-if="column.composite" v-once>@lang('voyager.Warning: this column is part of a composite index')</small>
    </td>
    ...
    Vue.component('database-column', {
        ...
        methods: {
            ...
            onIndexTypeChange(event) {
                if (this.column.name == '') {
                    return toastr.error("@lang("voyager.Please name the column before adding an index")");
                }
