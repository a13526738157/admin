@section('database-table-helper-buttons-template')
    <div>
        <div class="btn btn-success" @click="addNewColumn">@lang('voyager.+ Add New Field')</div>
        <div class="btn btn-success" @click="addTimestamps">@lang('voyager.+ Add Timestamp Fields')</div>
        <div class="btn btn-success" @click="addSoftDeletes">@lang('voyager.+ Add Soft Delete Field')</div>
    </div>
@endsection
