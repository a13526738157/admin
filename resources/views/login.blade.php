    ...
    <div class="row">
                ...
                <div class="col-sm-12 col-md-10 col-md-offset-2">
                    <div class="logo-title-container">
                        ...
                        <div class="copy animated fadeIn">
                            <h1>{{ Voyager::setting('admin_title','坚磐科技后台') }}</h1>
                            <p>{{ Voyager::setting('admin_description','欢迎使用坚磐科技后台') }}</p>
                        </div>
        ...
        <div class="col-xs-12 col-sm-4 col-md-3 login-sidebar animated fadeInRightBig">
            ...
            <div class="login-container animated fadeInRightBig">
                ...
                <h2>@lang('voyager.Sign in below')</h2>
                ...
                <button type="submit" class="btn btn-block login-button">
                    <span class="signingin hidden"><span class="glyphicon glyphicon-refresh"></span> @lang('voyager.Logging in...')</span>
                    <span class="signin">@lang('voyager.Login')</span>
                </button>
