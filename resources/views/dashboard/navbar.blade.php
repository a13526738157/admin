        ...
        <div class="navbar-header">
            ...
            <ol class="breadcrumb hidden-xs">
                @if(count(Request::segments()) == 1)
                    <li class="active"><i class="voyager-boat"></i> {{trans('voyager.slideBar.Dashboard')}}</li>
                @else
                    <li class="active">
                        <a href="{{ route('voyager.dashboard')}}"><i class="voyager-boat"></i> {{trans('voyager.slideBar.Dashboard')}}</a>
                    </li>
                @endif
