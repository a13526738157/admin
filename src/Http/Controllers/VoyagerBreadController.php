...
class VoyagerBreadController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!$request->ajax()) {
            ...
            ->with([
                'message'    => trans("voyager.Successfully Updated").$dataType->display_name_singular,
                'alert-type' => 'success',
                ]);
        }
    }
    ...
    public function destroy(Request $request, $id)
    {
        ...
        $data = $data->destroy($id)
            ? [
                'message'    => trans("voyager.Successfully Deleted").$dataType->display_name_singular,
                'alert-type' => 'success',
            ]
            : [
                'message'    => trans("voyager.Sorry it appears there was a problem deleting this").$dataType->display_name_singular,
                'alert-type' => 'error',
            ];
